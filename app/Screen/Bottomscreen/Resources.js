...
import { View, Text, ImageBackground, ActivityIndicator, Image, TouchableOpacity, StyleSheet, ScrollView, SafeAreaView, Dimensions, FlatList } from 'react-native';
        ...
        return (
            <View style={{ height: moderateScale(90), padding: scale(5),backgroundColor:"white" }}>
                <TouchableOpacity onPress={() => {
                    ...
                    style={{ width: "82%", height: moderateScale(52), borderRadius: 12, backgroundColor: "#E8C4FF", justifyContent: "center", alignItems: "center", marginLeft: scale(27) }}>
    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: "white" }}>
            ...
            <ScrollView style={{ flex: 1, backgroundColor: "white" }}>
                ...
                {Loder1 ? (<ActivityIndicator style={{ justifyContent: "flex-end", height: moderateScale(100) }} size={38} color={"black"} />) :
                    (<FlatList
            ...
            <View style={{ height: moderateScale(110), width: "100%",   alignItems: "center", flexDirection: "row" }}>
                <Image
                    ...
                    source={{ uri: "https://www.gifcen.com/wp-content/uploads/2021/07/well-done-gif-17.gif" }}
                />
            </View>
